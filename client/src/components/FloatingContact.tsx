  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
          ...
          >
            <div className="p-4">
              ...
              <div className="space-y-2">
                <a
                  href="tel:+19547560681"
                  className="flex items-center gap-3 font-body text-[0.8125rem] text-charcoal hover:text-sage transition-colors py-1.5"
                >
                  <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  Call Us
                </a>
                <a
                  href="https://wa.me/19547560681?text=Hi%20Noelle!%20I'm%20interested%20in%20learning%20more%20about%20your%20event%20planning%20services."
                  target="_blank"
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-sage text-white shadow-lg hover:bg-sage-dark transition-colors duration-300 flex items-center justify-center"
