        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-cormorant text-[2rem] md:text-[2.5rem] font-light text-charcoal leading-[1.2] mb-5">
              The Art of the <span className="italic text-gold">Invitation</span>
            </h2>
            <p className="font-body text-warm-gray text-[0.9375rem] leading-[1.8] mb-4">
              Your event begins the moment the invitation arrives. We design and produce
              stunning custom invitations — from letterpress wedding suites with gold foil
              and wax seals, to modern digital designs with built-in RSVP tracking.
            </p>
            ...
            {previewItems.map((item, i) => (
              ...
              >
                <Link to="/invitations" className="group block">
                  ...
                  <h3 className="font-cormorant text-lg font-light text-charcoal group-hover:text-gold transition-colors">
                    {item.label}
                  </h3>
                  <p className="font-body text-[0.8125rem] text-warm-gray mt-1">{item.description}</p>
                </Link>
              </motion.div>
            ))}
          </div>
