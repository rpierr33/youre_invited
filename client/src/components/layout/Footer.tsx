    ...
    <footer className="bg-charcoal text-white">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          {/* Brand */}
          <div>
            <span className="font-cormorant text-2xl font-medium text-gold tracking-wide">You're Invited</span>
            <p className="font-body text-[0.8125rem] text-white/40 mt-3 leading-relaxed">
              Fort Lauderdale's premier event planning company. Every celebration, perfectly yours.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {['Weddings', 'Corporate Events', 'Galas', 'Destination Events', 'Quinceañeras', 'Social Events'].map((s) => (
                <Link key={s} to="/services" className="font-body text-[0.8125rem] text-white/60 hover:text-gold transition-colors">
                  {s}
                </Link>
              ))}
            </div>
